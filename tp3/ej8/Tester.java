public class Tester {
    public static void main(String[] args){
        ...
        v1.egresaVehiculo(h6);
        v2.egresaVehiculo(h6);
        v3.egresaVehiculo(h6);
        v4.egresaVehiculo(h6);
        v5.egresaVehiculo(h6);
        v6.egresaVehiculo(h6);
        v33.egresaVehiculo(h6);
        ...
        System.out.println(v4.obtenerCobrar(tarifa));
